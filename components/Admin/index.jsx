...
const handeradd=(el)=>
{
  ...
  return (
    <div>
      <div className='Add'>
        <label>Add</label>
        <input placeholder='enter src Image' value={image} onChange={(el)=>setProduct({...product,image :el.target.value})}></input>
        <input placeholder='enter title' value={title} onChange={(el)=>setProduct({...product,title:el.target.value})}></input>
        <input placeholder='enter price' value={price} onChange={(el)=>setProduct({...product,price:el.target.value})}></input>
      ...
      <table>
        ...
        <tbody>
          {listproduct.map((el,index)=>(
            <tr key={index}>
              <td>{index}</td>
              <td><img src={el.image} alt=""></img></td>
              <td>{el.title}</td>
              <td>{el.price}</td>
             <td>
             <button className='button'>correct</button>
             </td>
             <td>
